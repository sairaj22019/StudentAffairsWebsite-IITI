      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-10">
          {quickLinks.map((item, index) => (
            ...
            >
              <div className="h-full flex flex-col items-center text-center  transition-transform duration-300">
                {/* Image Container */}
                <div className="w-full max-h-[200px] rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 mb-3 bg-gradient-to-br from-primary/10 to-accent/10 flex items-center justify-center">
                  <img
